...
<body>
    ...
    <header>
        <div id="top_line">
            <div class="container">
                <div class="row">
                   <div class="col-md-6 col-sm-6 col-xs-6"><i class="icon-phone"></i><!--<strong>+2349028511886, +2348025359144</strong>-->
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-3">
                    <h3>Need help?</h3>
                    <a href="tel://004542344599" id="phone">+2349028511886, +2348025359144</a>
