...
<body>
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="index.html">MITANEON</a>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="activex"><a href="{{route('admin.home')}}"><i class="icon-home4"></i> <span>Dashboard</span></a></li>
								<li>
									<a href="#"><i class="icon-stack2"></i> <span>Professional Cleaning</span></a>
									<ul>
										<li><a href="{{route('admin.allclean')}}">Bookings</a></li>
									<!--	<li><a href="#" id="layout2">Bookings <span class="label bg-warning-400">Delivered</span></a></li>
										<li><a href="#">Canceled</a></li>-->
										 
									</ul>
								</li>
								<li>
									<a href="#"><i class="icon-copy"></i> <span>Office Space</span></a>
									<ul>
									<!--	<li><a href="#" id="layout1">All Bookings</a></li>
										<li><a href="#" id="layout2">Bookings <span class="label bg-warning-400">Delivered</span></a></li>
										<li><a href="#" id="layout3">Canceled</a></li> -->
										<li><a href="{{route('home.booking')}}" id="layout3">Calendar</a></li>
										 
									</ul>
								</li>
								
								<li>
									<a href="#"><i class="icon-stack"></i> <span>Facility Management</span></a>
									<ul>
										<li><a href="{{route('admin.facility')}}">Bookings</a></li>
										 
									</ul>
								</li>
								<li>
									<a href="#"><i class="icon-droplet2"></i> <span>Users &amp; Roles</span></a>
									<ul>
